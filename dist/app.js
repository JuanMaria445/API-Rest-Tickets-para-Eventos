...
app.use("/api", users_router_1.default); // esto es un middleware define la ruta base en este caso para user events y bookings
app.use("/api", events_router_1.default);
app.use("/api", bookings_router_1.default);
exports.default = app;
