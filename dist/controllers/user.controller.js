...
const jwtSecret = process.env.JWT_SECRET; //usamos la variable de ambiente donde tenemos la clave secreta para crear el token
const jwtRefreshTokenSecret = process.env.JWT_REFRESH_TOKEN_SECRET; //usamos la variable de ambiente en el cual tenemos la clave secreta para el refresh token
const jwtSecretExpiration = process.env.JWT_SECRET_EXPIRATION; //usamos la variable de ambiente en el cual tenemos la duracion del token
const jwtRefreshTokenExpiration = process.env.JWT_REFRESH_TOKEN_EXPIRATION; //usamos la variable de ambiente en el cual tenemos la duracion del refresh token
...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield Users_1.User.update({ id: parseInt(id) }, actualizar);
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const result = yield Users_1.User.delete({ id: parseInt(id) });
        //se esta eliminando un único usuario
